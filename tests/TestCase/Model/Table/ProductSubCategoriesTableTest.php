...
class ProductSubCategoriesTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('ProductSubCategories') ? [] : ['className' => ProductSubCategoriesTable::class];
        $this->ProductSubCategories = TableRegistry::getTableLocator()->get('ProductSubCategories', $config);
    }
