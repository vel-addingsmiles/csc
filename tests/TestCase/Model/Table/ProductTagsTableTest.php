...
class ProductTagsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = TableRegistry::getTableLocator()->exists('ProductTags') ? [] : ['className' => ProductTagsTable::class];
        $this->ProductTags = TableRegistry::getTableLocator()->get('ProductTags', $config);
    }
