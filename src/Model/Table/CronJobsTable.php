 ...
 * @method \App\Model\Entity\CronJob|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \App\Model\Entity\CronJob saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
