                    ...
                    <div class="wrap container-fluid">
                        <div class="row">
                            ...
                            <div class="col-lg-9 col-md-9 col-sm-8">
                                ...
                                <div class="information-title">Account Information</div>
                                <div class="details-wrap">
                                    <div class="block-title alt"> <i class="fa fa-angle-down"></i> Edit your account </div>
                                    <div class="details-box">
                                        <?= $this->Form->create($user,['novalidate' => true , 'class' => 'form-delivery' ]) ?>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-sm-12">
                                                     <?= $this->Form->button(__('Update Your Information'),['class' => 'btn btn-theme btn-theme-dark']) ?>
                                                </div>
                                            </div>
                                         <?= $this->Form->end() ?>
                                    </div>
