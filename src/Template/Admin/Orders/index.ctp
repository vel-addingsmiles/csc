                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select class="form-control order_status" order-id="<?php echo $order['id']; ?>">
                                                <option value="0" <?php if($order['invoice_status'] == 0){ echo "Selected"; } ?>>Recieved</option>
                                                <option value="1" <?php if($order['invoice_status'] == 1){ echo "Selected"; } ?>>Confirmed</option>
                                                <option value="2" <?php if($order['invoice_status'] == 2){ echo "Selected"; } ?>>Shipped</option>
                                                <option value="3" <?php if($order['invoice_status'] == 3){ echo "Selected"; } ?>>Delivered</option>
                                                <option value="4" <?php if($order['invoice_status'] == 4){ echo "Selected"; } ?>>Cancelled</option>
                                            </select>
                                        </td>
                                        <td>
