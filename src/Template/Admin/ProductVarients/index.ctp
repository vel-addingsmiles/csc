                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                            ...
                            <tbody>
                                <?php $i = 1; foreach ($productVarients as $key => $productVarient) {  ?>
                                    <tr>
                                        <td><?php echo $i; ?></td>
                                        <td><?php echo $productVarient['name']; ?></td>
                                        <td><?php echo $productVarient['created']; ?></td>
                                        <td>
                                            <div class="btn-group">
                                                <a href="<?php echo $this->Url->build('/admin/product-varients/edit/'.$productVarient->id); ?>" type="button" class="btn btn-outline-secondary btn-sm"><i class="far fa-edit"></i></a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php $i++; } ?>
